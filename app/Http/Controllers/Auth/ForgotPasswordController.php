...
class ForgotPasswordController extends Controller
{
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        // Find user by correo field (our custom field name)
        ...
        // Generate token using our custom repository
        ...
        return back()->with([
            'status' => 'Te hemos enviado un correo con las instrucciones para restablecer tu contraseña.',
            'reset_email' => $user->correo
        ]);
    }
}

...
class ApoderadoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'numero_escritura_constitutiva_poder' => 'nullable|string|max:255',
            'numero_registro_publico_poder' => 'nullable|string|max:255',
            'fecha_inscripcion_poder' => 'nullable|date|before_or_equal:today',

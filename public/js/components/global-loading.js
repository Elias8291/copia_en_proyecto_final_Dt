...
class GlobalLoading {
    ...
    createLoadingElement() {
        try {
            ...
            console.warn('Error creating loading element:', error);
        }
    }
    ...
    addStyles() {
        try {
            ...
            if (document.head) {
                ...
                // If head is not available, wait for DOM to be ready
                document.addEventListener('DOMContentLoaded', () => {
            ...
            console.warn('Error adding global loading styles:', error);
        }
    }
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => {
        try {
            ...
            console.warn('Error initializing GlobalLoading:', error);
        }
    });
} else {
    try {
...
window.showLoadingFor = (duration, options) => {
    try {
        ...
        console.warn('Error showing loading for duration:', error);
    }
};

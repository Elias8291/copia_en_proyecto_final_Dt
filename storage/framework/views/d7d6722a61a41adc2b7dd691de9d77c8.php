...
<head>
    ...
    <style>
        ...
        .number-container::before {
            content: '<?php echo $__env->yieldContent('code'); ?>';
            position: absolute;
            left: 0;
            top: 0;
            z-index: -1;
            ...
            <div class="grid md:grid-cols-2 gap-4 sm:gap-8 items-center">
                ...
                <div class="flex justify-center order-1 md:order-none">
                    <div class="float-animation">
                        <img src="<?php echo e(\App\Helpers\ErrorImageHelper::getRandomErrorImage()); ?>" 
                             alt="Error <?php echo $__env->yieldContent('code'); ?>" 
                             class="w-56 sm:w-72 h-auto drop-shadow-xl"
                             onerror="this.src='<?php echo e(asset('images/logoColor.png')); ?>'">
                    </div>
                </div>
                ...
                <div class="text-center md:text-left order-2 md:order-none">
                    <div class="relative mb-6">
                        <div class="number-container">
                            <h1 class="text-8xl sm:text-9xl font-bold glow-effect tracking-wider"><?php echo $__env->yieldContent('code'); ?></h1>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        <div class="space-y-6">
                            <h2 class="text-2xl sm:text-3xl font-semibold text-gray-800">
                                <?php echo $__env->yieldContent('header-message'); ?>
                            </h2>
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                        ...
                        <?php if(!View::hasSection('buttons')): ?>
...
</html><?php /**PATH C:\Users\Elias\Documents\copia_en_proyecto_final_Dt\resources\views/errors/layout.blade.php ENDPATH**/ ?>
    ...
    <div class="relative flex-1 flex flex-col max-w-xs w-full bg-gradient-to-b from-white to-gray-50">
        ...
        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <nav class="px-3 space-y-2">
                <!-- Dashboard -->
                <a href="<?php echo e(route('dashboard')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('dashboard') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="<?php echo e(route('users.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('users.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="<?php echo e(route('roles.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('roles.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Trámites -->
                <a href="<?php echo e(route('tramites.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('tramites.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="<?php echo e(route('revisiones.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('revisiones.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="<?php echo e(route('citas.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('citas.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('archivos.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('archivos.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('proveedores.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('proveedores.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Reportes Dinámicos -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('proveedores.ver')): ?>
                <a href="<?php echo e(route('reportes.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    <?php echo e(request()->routeIs('reportes.*') ? 'bg-primary-50 text-primary border-l-4 border-primary shadow-sm' : 'text-gray-700 hover:bg-white hover:shadow-md hover:text-primary'); ?>">
                    <svg class="<?php echo e(request()->routeIs('reportes.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
                    <span class="font-medium tracking-wide">📊 Reportes Dinámicos</span>
                </a>
                <?php endif; ?>
            ...
            if (unreadNotifications.length > 0) {
                try {
                    ...
                    <a href="<?php echo e(route('notificaciones.index')); ?>" @click="sidebarOpen = false"
                       ...
                       <?php echo e(request()->routeIs('notificaciones.*') ? 'bg-primary-50 text-primary border-l-4 border-primary shadow-sm' : 'text-gray-700 hover:bg-white hover:shadow-md hover:text-primary'); ?>">
                        <div class="relative">
                            <svg class="<?php echo e(request()->routeIs('notificaciones.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3 transition-all duration-200"
                    ...
                    <div x-show="open" 
                        ...
                        <div class="px-4 py-3 border-b border-gray-100 bg-gray-50">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="<?php echo e(route('notificaciones.index')); ?>" class="text-xs text-blue-600 hover:text-blue-800 font-medium">
                                    Ver todas
                                </a>
                            </div>
                        </div>
                ...
                <a href="<?php echo e(route('profile.index')); ?>" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="<?php echo e(request()->routeIs('profile.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary'); ?> flex-shrink-0 w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
</div> <?php /**PATH C:\Users\Elias\Documents\copia_en_proyecto_final_Dt\resources\views/layouts/sidebar-mobile.blade.php ENDPATH**/ ?>
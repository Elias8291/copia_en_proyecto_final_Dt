<?php $__env->startSection('title', 'Cargar Constancia'); ?>

<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('components.ui.modals.loading-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.modals.general.error', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.ui.modals.sat-data-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
            ...
            <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl overflow-hidden border border-gray-200/70">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-base text-gray-500 mt-1">
                                    ...
                                    <strong><?php echo e(ucfirst($tipo)); ?></strong>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-4 sm:p-6 lg:p-8">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700 mb-2">
                                    Para continuar con el trámite de <strong><?php echo e(ucfirst($tipo)); ?></strong>, necesitamos que subas tu constancia de situación fiscal vigente. 
                                ...
                                <div class="bg-white border border-blue-200 rounded-md p-2">
                                    <p class="text-xs text-blue-600 font-medium">
                                        <strong>Tipo de trámite:</strong> <?php echo e(ucfirst($tipo)); ?>
                            ...
                            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-100 border border-red-200 shadow-sm animate-fadeInUp">
                                ...
                                <span class="text-xs text-red-700 font-medium">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php elseif($errors->has('sat_file')): ?>
                                            No se pudo procesar el archivo fiscal
                                        <?php elseif($errors->has('sat_rfc')): ?>
                    ...
                    <!-- Formulario de carga -->
                    <form action="<?php echo e(route('tramites.procesar-constancia')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        
                        <!-- Área de carga de archivo -->
                        <div id="uploadArea" class="transition-all duration-300 ease-in-out min-h-[80px] <?php echo e($mostrarFormulario ? 'hidden' : ''); ?>">
                            <div class="mt-1">
                                ...
                                <div class="relative">
                                    ...
                                    <label for="document" class="group flex flex-col items-center justify-center w-full h-16 border-2 border-dashed <?php $__errorArgs = ['document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50/30 <?php elseif($errors->has('sat_file')): ?> border-red-300 bg-red-50/30 <?php else: ?> border-[#9D2449]/20 bg-[#9D2449]/5 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> hover:border-[#9D2449] rounded-lg transition-all duration-300 cursor-pointer hover:bg-[#9D2449]/10">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="text-center md:text-left">
                                                <p class="<?php $__errorArgs = ['document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-red-500 <?php elseif($errors->has('sat_file')): ?> text-red-500 <?php else: ?> text-[#9D2449]/70 group-hover:text-[#9D2449] <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> font-medium text-xs mb-0">
                                                    Haga clic para seleccionar archivo
                                                </p>
                                                <p class="text-xs <?php $__errorArgs = ['document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-red-400 <?php elseif($errors->has('sat_file')): ?> text-red-400 <?php else: ?> text-gray-500 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>" id="fileName">
                                                    PDF con QR
                                                </p>
                                            </div>
                                        </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <div class="mt-1">
                                        <span class="text-xs text-red-500 font-medium" id="document-error"><?php echo e($message); ?></span>
                                    </div>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                <?php $__errorArgs = ['sat_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <div class="mt-1">
                                        <span class="text-xs text-red-500 font-medium" id="sat-file-error"><?php echo e($message); ?></span>
                                    </div>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="extractedData" class="hidden space-y-4">
                            <input type="hidden" id="qr_url" name="qr_url" value="<?php echo e(old('qr_url')); ?>">
                            <input type="hidden" id="sat_rfc" name="sat_rfc" value="<?php echo e(old('sat_rfc')); ?>">
                            <input type="hidden" id="sat_nombre" name="sat_nombre" value="<?php echo e(old('sat_nombre')); ?>">
                            <input type="hidden" id="sat_tipo_persona" name="sat_tipo_persona" value="<?php echo e(old('sat_tipo_persona')); ?>">
                            <input type="hidden" id="sat_email" name="sat_email" value="<?php echo e(old('sat_email')); ?>">
                            <input type="hidden" id="sat_curp" name="sat_curp" value="<?php echo e(old('sat_curp')); ?>">
                            <!-- Datos del domicilio -->
                            <input type="hidden" id="sat_calle" name="sat_calle" value="<?php echo e(old('sat_calle')); ?>">
                            <input type="hidden" id="sat_numero_exterior" name="sat_numero_exterior" value="<?php echo e(old('sat_numero_exterior')); ?>">
                            <input type="hidden" id="sat_numero_interior" name="sat_numero_interior" value="<?php echo e(old('sat_numero_interior')); ?>">
                            <input type="hidden" id="sat_colonia" name="sat_colonia" value="<?php echo e(old('sat_colonia')); ?>">
                            <input type="hidden" id="sat_cp" name="sat_cp" value="<?php echo e(old('sat_cp')); ?>">
                            <input type="hidden" id="sat_municipio" name="sat_municipio" value="<?php echo e(old('sat_municipio')); ?>">
                            <input type="hidden" id="sat_entidad_federativa" name="sat_entidad_federativa" value="<?php echo e(old('sat_entidad_federativa')); ?>">
    ...
    <script src="<?php echo e(asset('vendor/pdfjs-dist/pdf.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/pdfjs-dist/pdf.worker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/jsQR/jsQR.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/sat-qr-extractor/qr-extractor-simple.js')); ?>"></script>
    <script src="<?php echo e(asset('js/sat-qr-extractor/sat-scraper-simple.js')); ?>"></script>
    <script src="<?php echo e(asset('js/sat-qr-extractor/constancia-extractor.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Elias\Documents\copia_en_proyecto_final_Dt\resources\views/tramites/cargar_constancia.blade.php ENDPATH**/ ?>
...
<div class="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8">
    <div class="max-w-7xl mx-auto bg-white shadow-sm rounded-lg border border-gray-200">        
        <div class="p-6 border-b border-gray-200/70">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('tramites.index')); ?>" 
        ...
        <div class="p-6">
            <?php if(session('success') && session('tramite_creado') === true): ?>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800">
                                Gestión del Proveedor - <?php echo e(ucfirst($infoProveedor['tipo_tramite'])); ?>

                            </h3>
                            <div class="mt-2 text-sm text-blue-700">
                                <p class="mb-2"><?php echo e($infoProveedor['mensaje_usuario']); ?></p>
                                
                                <?php if($infoProveedor['proveedor_existente']): ?>
                                    <div class="bg-white rounded-md p-3 mt-3">
                                        ...
                                        <div class="grid grid-cols-2 gap-2 text-xs">
                                            <div>
                                                ...
                                                <span class="text-blue-600"><?php echo e($infoProveedor['proveedor_existente']['pv_numero']); ?></span>
                                            </div>
                                            <div>
                                                <span class="font-medium">Estado:</span> 
                                                <span class="px-2 py-1 rounded text-xs <?php echo e($infoProveedor['proveedor_existente']['esta_vigente'] ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    <?php echo e($infoProveedor['proveedor_existente']['estado_padron']); ?>

                                                </span>
                                            </div>
                                            <div>
                                                <span class="font-medium">Fecha Registro:</span> 
                                                <span class="text-blue-600"><?php echo e($infoProveedor['proveedor_existente']['fecha_registro'] ? $infoProveedor['proveedor_existente']['fecha_registro']->format('d/m/Y') : 'N/A'); ?></span>
                                            </div>
                                            <div>
                                                <span class="font-medium">Fecha Vencimiento:</span> 
                                                <span class="text-blue-600"><?php echo e($infoProveedor['proveedor_existente']['fecha_vencimiento'] ? $infoProveedor['proveedor_existente']['fecha_vencimiento']->format('d/m/Y') : 'N/A'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('tramites.store')); ?>" enctype="multipart/form-data" id="tramite-form">
                <?php echo csrf_field(); ?>
                
                <!-- Campo oculto para tipo de trámite -->
                <input type="hidden" name="tipo_tramite" value="<?php echo e(session('tipo_tramite_seleccionado')); ?>">
                ...
                <!-- Componente de Steps -->
                <?php if (isset($component)) { $__componentOriginal562fe44114eea5b5eab2f43dc65c35e8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal562fe44114eea5b5eab2f43dc65c35e8 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.navigation.steps','data' => ['steps' => $steps,'currentStep' => 0,'totalSteps' => $totalSteps]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('navigation.steps'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['steps' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($steps),'current-step' => 0,'total-steps' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($totalSteps)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal562fe44114eea5b5eab2f43dc65c35e8)): ?>
<?php $attributes = $__attributesOriginal562fe44114eea5b5eab2f43dc65c35e8; ?>
<?php unset($__attributesOriginal562fe44114eea5b5eab2f43dc65c35e8); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal562fe44114eea5b5eab2f43dc65c35e8)): ?>
<?php $component = $__componentOriginal562fe44114eea5b5eab2f43dc65c35e8; ?>
<?php unset($__componentOriginal562fe44114eea5b5eab2f43dc65c35e8); ?>
<?php endif; ?>

                <!-- Contenido de los pasos -->
                <div class="step-content active" data-step="0">
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                        <?php echo $__env->make('components.forms.datos-generales', [
                            'editable' => true, 
                ...
                <div class="step-content" data-step="1">
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                        <?php echo $__env->make('components.forms.actividades-economicas', ['editable' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>

                <div class="step-content" data-step="2">
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                        <?php echo $__env->make('components.forms.domicilio', [
                            'editable' => true, 
                            'datosConstancia' => $viewModel
                        ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                ...
                <?php if($tipoPersona === 'Moral'): ?>
                    <div class="step-content" data-step="3">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                            <?php echo $__env->make('components.forms.constitucion', [
                                'editable' => true,
                    ...
                    <div class="step-content" data-step="4">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                            <?php echo $__env->make('components.forms.accionistas', [
                                'editable' => true,
                    ...
                    <div class="step-content" data-step="5">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                            <?php echo $__env->make('components.forms.apoderado', [
                                'editable' => true,
                    ...
                    <div class="step-content" data-step="6">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                            <?php echo $__env->make('components.forms.archivos-dinamicos', [
                                'editable' => true, 
...
<?php if (isset($component)) { $__componentOriginal63ac9d389bfea79d60a724b09631f082 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal63ac9d389bfea79d60a724b09631f082 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.modals.modal-confirmacion','data' => ['id' => 'modal-confirmacion-tramite','title' => 'Confirmar envío','message' => '¿Está seguro que desea enviar el trámite?','confirmText' => 'Sí, enviar','cancelText' => 'Cancelar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.modals.modal-confirmacion'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-confirmacion-tramite','title' => 'Confirmar envío','message' => '¿Está seguro que desea enviar el trámite?','confirmText' => 'Sí, enviar','cancelText' => 'Cancelar']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal63ac9d389bfea79d60a724b09631f082)): ?>
<?php $attributes = $__attributesOriginal63ac9d389bfea79d60a724b09631f082; ?>
<?php unset($__attributesOriginal63ac9d389bfea79d60a724b09631f082); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal63ac9d389bfea79d60a724b09631f082)): ?>
<?php $component = $__componentOriginal63ac9d389bfea79d60a724b09631f082; ?>
<?php unset($__componentOriginal63ac9d389bfea79d60a724b09631f082); ?>
<?php endif; ?>

<!-- Modal de Términos de Servicio -->
<?php echo $__env->make('components.modals.terminos-servicio', ['id' => 'modal-terminos-servicio'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<!-- Sistema de validación -->
<script type="module" src="<?php echo e(asset('js/validations/index.js')); ?>"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if(isset($viewModel)): ?>
        ...
        if (razonSocial && !razonSocial.value) {
            razonSocial.value = '<?php echo e($viewModel->getDatosGenerales()["razon_social"] ?? ""); ?>';
        }
        if (rfc && !rfc.value) {
            rfc.value = '<?php echo e($viewModel->getDatosGenerales()["rfc"] ?? ""); ?>';
        }
        if (curp && !curp.value) {
            curp.value = '<?php echo e($viewModel->getDatosGenerales()["curp"] ?? ""); ?>';
        }
        ...
        if (calle && !calle.value) {
            calle.value = '<?php echo e($datosDomicilio["calle"] ?? ""); ?>';
        }
        if (numeroExterior && !numeroExterior.value) {
            numeroExterior.value = '<?php echo e($datosDomicilio["numero_exterior"] ?? ""); ?>';
        }
        if (numeroInterior && !numeroInterior.value) {
            numeroInterior.value = '<?php echo e($datosDomicilio["numero_interior"] ?? ""); ?>';
        }
        if (colonia && !colonia.value) {
            colonia.value = '<?php echo e($datosDomicilio["asentamiento"] ?? ""); ?>';
        }
        if (codigoPostal && !codigoPostal.value) {
            codigoPostal.value = '<?php echo e($datosDomicilio["codigo_postal"] ?? ""); ?>';
        }
        if (municipio && !municipio.value) {
            municipio.value = '<?php echo e($datosDomicilio["municipio"] ?? ""); ?>';
        }
        if (estado && !estado.value) {
            estado.value = '<?php echo e($datosDomicilio["estado"] ?? ""); ?>';
        }
    <?php endif; ?>
    ...
    <?php if($errors->any()): ?>
        <?php $__currentLoopData = $errors->keys(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            var field = document.querySelector('[name="<?php echo e($field); ?>"]');
            if (field) {
...
<script src="<?php echo e(asset('js/revision/archivos-tiempo-real.js')); ?>"></script>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Elias\Documents\copia_en_proyecto_final_Dt\resources\views/tramites/create.blade.php ENDPATH**/ ?>
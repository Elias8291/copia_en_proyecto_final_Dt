                ...
                <div class="p-6 border-b border-gray-100">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        ...
                        <div class="flex flex-col lg:flex-row items-center space-y-3 lg:space-y-0 lg:space-x-3">
                            ...
                            <!-- Badge de Rol -->
                            <?php if(auth()->user()->hasRole(['Administrador', 'Super Administrador'])): ?>
                            ...
                            <?php elseif(auth()->user()->hasRole(['Revisor Digital', 'Revisor Presencial', 'Revisor Domiciliario'])): ?>
                ...
                <div class="p-6 bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-200/70">
                    <div class="mb-6">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-800 mb-2">
                                Buenos días, <?php echo e(auth()->check() ? auth()->user()->nombre : 'Invitado'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <?php if(auth()->user()->hasRole(['Administrador', 'Super Administrador'])): ?>
                            ...
                            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 cursor-pointer" onclick="window.location.href='<?php echo e(route('users.index')); ?>'">
                                <div class="flex items-center space-x-4">
                            ...
                            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 cursor-pointer" onclick="window.location.href='<?php echo e(route('roles.index')); ?>'">
                                <div class="flex items-center space-x-4">
                            ...
                            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 cursor-pointer" onclick="window.location.href='<?php echo e(route('tramites.index')); ?>'">
                                <div class="flex items-center space-x-4">
                            ...
                            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 cursor-pointer" onclick="window.location.href='<?php echo e(route('citas.index')); ?>'">
                                <div class="flex items-center space-x-4">
                            ...
                            <!-- Card para archivos -->
                            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 cursor-pointer" onclick="window.location.href='<?php echo e(route('archivos.index')); ?>'">
                                <div class="flex items-center space-x-4">
                            ...
                            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 cursor-pointer" onclick="window.location.href='<?php echo e(route('revisiones.index')); ?>'">
                                <div class="flex items-center space-x-4">
                            ...
                            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 cursor-pointer" onclick="window.location.href='<?php echo e(route('notificaciones.index')); ?>'">
                                <div class="flex items-center space-x-4">
                        ...
                        <?php if(auth()->user()->hasRole(['Revisor Digital', 'Revisor Presencial', 'Revisor Domiciliario'])): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Elias\Documents\copia_en_proyecto_final_Dt\resources\views/dashboard/administrador-revisor.blade.php ENDPATH**/ ?>
...
<div class="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8">
    <div class="max-w-full mx-auto bg-white shadow-sm rounded-lg border border-gray-200">        
        ...
        <div class="border-t border-gray-100 mb-4 sm:mb-5 md:mb-6 lg:mb-8">
            <form method="GET" action="<?php echo e(route('users.index')); ?>" class="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8" id="searchForm">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-3 md:gap-4 lg:gap-6">
                            <div>
                                ...
                                <select name="rol" 
                                    ...
                                    <option value="user" <?php echo e(request('rol') == 'user' ? 'selected' : ''); ?>>Usuario</option>
                                    <option value="moderator" <?php echo e(request('rol') == 'moderator' ? 'selected' : ''); ?>>Moderador</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="año" 
                                    ...
                                    <?php for($year = 2020; $year <= date('Y') + 1; $year++): ?>
                                        <option value="<?php echo e($year); ?>" <?php echo e(request('año') == $year ? 'selected' : ''); ?>><?php echo e($year); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                        </div>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 md:gap-5">
                <div class="flex items-center gap-2 sm:gap-3">
                    ...
                    <p class="text-xs sm:text-sm md:text-base lg:text-lg text-gray-700">
                        <span class="font-medium text-[#9d2449]"><?php echo e($users->total()); ?></span> 
                        <?php echo e($users->total() == 1 ? 'usuario encontrado' : 'usuarios encontrados'); ?>

                        <?php if($users->hasPages()): ?>
                            <span class="text-gray-500 ml-1 sm:ml-2 md:ml-3">
                                (<?php echo e($users->firstItem()); ?>-<?php echo e($users->lastItem()); ?>)
                            </span>
                        <?php endif; ?>
                    </p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 md:gap-4">
                    ...
                    <!-- Filtros activos -->
                    <?php if(request()->hasAny(['search', 'rol', 'estado', 'año'])): ?>
                    <div class="flex flex-wrap items-center gap-1.5 sm:gap-2 md:gap-3">
                        ...
                        <span class="inline-flex items-center px-1.5 sm:px-2 md:px-2.5 py-0.5 sm:py-1 md:py-1.5 rounded-full text-xs sm:text-sm font-medium bg-[#9d2449]/10 text-[#9d2449] border border-[#9d2449]/20">
                            Rol: <?php echo e(ucfirst(request('rol'))); ?>

                            <a href="<?php echo e(request()->fullUrlWithQuery(['rol' => null])); ?>" class="ml-1 sm:ml-1.5 text-[#9d2449] hover:text-[#8a1f40]">
                                <svg class="w-2.5 h-2.5 sm:w-3 sm:h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                            </a>
                        ...
                        <span class="inline-flex items-center px-1.5 sm:px-2 md:px-2.5 py-0.5 sm:py-1 md:py-1.5 rounded-full text-xs sm:text-sm font-medium bg-gray-100 text-gray-700 border border-gray-200">
                            Estado: <?php echo e(ucfirst(request('estado'))); ?>

                            <a href="<?php echo e(request()->fullUrlWithQuery(['estado' => null])); ?>" class="ml-1 sm:ml-1.5 text-gray-700 hover:text-gray-900">
                                <svg class="w-2.5 h-2.5 sm:w-3 sm:h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                            </a>
                        ...
                        <?php if(request('año')): ?>
                        <span class="inline-flex items-center px-1.5 sm:px-2 md:px-2.5 py-0.5 sm:py-1 md:py-1.5 rounded-full text-xs sm:text-sm font-medium bg-gray-100 text-gray-700 border border-gray-200">
                            Año: <?php echo e(request('año')); ?>

                            <a href="<?php echo e(request()->fullUrlWithQuery(['año' => null])); ?>" class="ml-1 sm:ml-1.5 text-gray-700 hover:text-gray-900">
                                <svg class="w-2.5 h-2.5 sm:w-3 sm:h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                            </a>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 py-3 sm:py-4 md:py-5">
                                <div class="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                                    <div class="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-[#9d2449] rounded-lg flex items-center justify-center flex-shrink-0">
                                        <span class="text-white font-semibold text-xs sm:text-sm md:text-base"><?php echo e(strtoupper(substr($user->name ?? 'U', 0, 1))); ?></span>
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <div class="font-semibold text-gray-900 truncate max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl text-xs sm:text-sm md:text-base" title="<?php echo e($user->name ?? 'N/A'); ?>">
                                            <?php echo e($user->name ?? 'N/A'); ?>

                                        </div>
                                        <div class="text-xs sm:text-sm text-gray-500">ID: <?php echo e($user->id); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 py-3 sm:py-4 md:py-5">
                                <span class="text-gray-900 text-xs sm:text-sm md:text-base"><?php echo e($user->email ?? 'N/A'); ?></span>
                            </td>
                            <td class="px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 py-3 sm:py-4 md:py-5">
                                <?php
                            ...
                            <td class="px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 py-3 sm:py-4 md:py-5">
                                ...
                                ?>
                                <span class="inline-flex items-center px-2 sm:px-2.5 md:px-3 py-1 sm:py-1.5 md:py-2 rounded-full text-xs sm:text-sm font-medium <?php echo e($statusClass); ?>">
        ...
        <div class="border-t border-gray-100 pt-4 sm:pt-5 md:pt-6 lg:pt-8">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-2 sm:p-3 md:p-4 lg:p-5">
                <div class="flex items-start justify-between mb-2 sm:mb-3 md:mb-4">
                    <div class="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 lg:space-x-4 min-w-0 flex-1">
                        <div class="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 bg-[#9d2449] rounded-lg flex items-center justify-center flex-shrink-0">
                            <span class="text-white font-semibold text-xs sm:text-sm md:text-base lg:text-lg"><?php echo e(strtoupper(substr($user->name ?? 'U', 0, 1))); ?></span>
                        </div>
                        <div class="min-w-0 flex-1">
                            <span class="text-gray-700 font-medium text-xs sm:text-sm md:text-base lg:text-lg block">ID: <?php echo e($user->id); ?></span>
                            <?php
                                $roleNames = $user->roles->pluck('name')->toArray();
                                $roleName = !empty($roleNames) ? ucfirst($roleNames[0]) : 'Sin rol';
                            ?>
                            <p class="text-xs sm:text-sm md:text-base text-gray-500 truncate"><?php echo e($roleName); ?></p>
                        </div>
                    </div>
                ...
                <div class="space-y-1 sm:space-y-1.5 md:space-y-2 lg:space-y-3">
                    <div class="text-xs sm:text-sm md:text-base lg:text-lg font-semibold text-gray-800 truncate" title="<?php echo e($user->name ?? 'N/A'); ?>">
                        <?php echo e($user->name ?? 'N/A'); ?>
                    ...
                    <div class="text-xs sm:text-sm md:text-base text-gray-600">
                        Registro: <?php echo e($user->created_at ? $user->created_at->format('d/m/Y') : 'N/A'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.modals.modal-exito','data' => ['id' => 'success-modal','title' => '¡Éxito!','message' => 'La operación se realizó correctamente.','acceptText' => 'Aceptar','redirectUrl' => route('users.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'success-modal','title' => '¡Éxito!','message' => 'La operación se realizó correctamente.','acceptText' => 'Aceptar','redirectUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('users.index'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Elias\Documents\copia_en_proyecto_final_Dt\resources\views/users/index.blade.php ENDPATH**/ ?>
...
<div class="mb-6" data-steps-container>
    ...
    <div class="w-full bg-gray-200 rounded-full h-2 mb-6">
        <div class="bg-[#9d2449] h-2 rounded-full transition-all duration-500" 
             ...
             style="width: <?php echo e(round((($currentStep + 1) / $totalSteps) * 100)); ?>%"></div>
    </div>
    ...
    <div class="block sm:hidden mb-4">
        <div class="text-center">
            <div class="inline-flex items-center justify-center w-10 h-10 bg-[#9d2449] text-white rounded-full font-bold text-sm" id="mobile-step-number">
                <?php echo e($currentStep + 1); ?>/<?php echo e($totalSteps); ?>
            ...
            <div class="flex flex-col items-center flex-1 relative">
                ...
                <?php if($index < count($steps) - 1): ?>
                    <div class="absolute top-5 left-5 w-full h-0.5 bg-gray-300 transition-all duration-300
                                <?php echo e($index < $currentStep ? 'bg-[#9d2449]' : ''); ?>"></div>
                <?php endif; ?>
                
                <!-- Step Label -->
                <div class="mt-2 text-center px-1">
                    <p class="text-xs font-medium <?php echo e($index <= $currentStep ? 'text-[#9d2449]' : 'text-gray-500'); ?> transition-colors duration-300">
...
const steps = <?php echo json_encode($steps, 15, 512) ?>;
...
</script> <?php /**PATH C:\Users\Elias\Documents\copia_en_proyecto_final_Dt\resources\views/components/navigation/steps.blade.php ENDPATH**/ ?>
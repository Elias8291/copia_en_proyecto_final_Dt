...
<?php if(session('success') && session('success_title') && session('success_message') && request()->is('revisiones/revisar*')): ?>
<div id="<?php echo e($id); ?>" class="fixed z-50 inset-0 overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6"
            ...
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline-<?php echo e($id); ?>">
                        <?php echo e(session('success_title', $title)); ?>

                    </h3>
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">
                            <?php echo e(session('success_message', $message)); ?>
            ...
            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <button type="button" 
                        onclick="limpiarSesionExito('<?php echo e(session('success_redirect', $redirectUrl)); ?>')"
                        class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">
                    <?php echo e(session('success_accept_text', $acceptText)); ?>
...
<?php endif; ?> <?php /**PATH C:\Users\Elias\Documents\copia_en_proyecto_final_Dt\resources\views/components/ui/modals/modal-exito.blade.php ENDPATH**/ ?>
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:gap-6">
            ...
            <div class="form-group field-container">
                ...
                <div class="relative group">
                    ...
                    <input type="date"
                        name="fecha_poder"
                        value="{{ old('fecha_poder', $datos['fecha_poder'] ? \Carbon\Carbon::parse($datos['fecha_poder'])->format('Y-m-d') : '') }}"
            ...
            <div class="form-group field-container">
                ...
                <div class="relative group">
                    ...
                    <input type="date"
                        ...
                        value="{{ old('fecha_inscripcion_poder', $datos['fecha_inscripcion_poder'] ? \Carbon\Carbon::parse($datos['fecha_inscripcion_poder'])->format('Y-m-d') : '') }}"

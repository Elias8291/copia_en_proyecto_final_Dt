...
<div class="w-full max-w-7xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-200/50 p-8 -mt-4">
        ...
        <div class="p-4 border-b border-gray-100">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold text-gray-800">Crear Rol</h1>
    ...
    <div class="bg-gray-50/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50">
        <form action="{{ route('roles.store') }}" method="POST" class="space-y-4 p-4">
            @csrf
            ...
            <div class="border-b border-gray-100 pb-4">
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 max-h-60 overflow-y-auto border border-gray-200 rounded-lg p-3">

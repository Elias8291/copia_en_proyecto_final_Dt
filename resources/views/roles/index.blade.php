            ...
            <div class="p-6 bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-200/70">
                ...
                <div class="flex flex-wrap items-center justify-center gap-3 mb-4">
                    ...
                    <div class="relative">
                        ...
                        <select id="permisos-filter" class="appearance-none bg-white border border-gray-300 rounded-lg pl-10 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/30 focus:border-[#B4325E] transition-all duration-200 hover:shadow-sm min-w-[140px]">
                            <option value="">Todos los roles</option>
                            <option value="sin-permisos">Sin permisos</option>
                            <option value="con-permisos">Con permisos</option>
                        </select>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="relative">
                            <select id="per-page-selector" onchange="changePerPage(this.value)" class="appearance-none bg-white border border-gray-300 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/30 focus:border-[#B4325E] transition-all duration-200 hover:shadow-sm min-w-[70px]">
...
document.addEventListener('DOMContentLoaded', function() {
    new TablaFiltros({
        ...
        filtros: [
            ...
            { id: 'permisos-filter', columna: 2, selector: 'span', tipo: 'permisos', label: 'permisos' }
        ]
    });

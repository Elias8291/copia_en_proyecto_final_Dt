...
<body>
    ...
    <div class="destinatario">
        <div class="destinatario-persona-moral">
            @if(isset($datosConstitutivos) && isset($datosConstitutivos->representanteLegal) && $datosConstitutivos->representanteLegal->nombre_completo)
                {{ strtoupper($datosConstitutivos->representanteLegal->nombre_completo) }}<br>
            @endif
            
            @if(isset($datosGenerales) && $datosGenerales->razon_social)
            ...
            @if(isset($proveedor) && $proveedor->rfc)

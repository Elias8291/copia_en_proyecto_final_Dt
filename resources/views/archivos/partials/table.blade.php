            ...
            <tr class="hover:bg-gray-50/50 transition-colors duration-200">
                            ...
                            @elseif($archivo->tipo_archivo === 'png')
                                <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                                    <svg class="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M4 3a1 1 0 00-1 1v16a1 1 0 001 1h16a1 1 0 001-1V4a1 1 0 00-1-1H4zm12 4a2 2 0 11-4 0 2 2 0 014 0zm-8 8l2-6 3 4 3-2 3 4H8z"/>
                                    </svg>
                                </div>
                            @else
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                        {{ $archivo->tipo_persona === 'Física' ? 'bg-blue-100 text-blue-800' : 
                           ($archivo->tipo_persona === 'Moral' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800') }}">
...
<script>
function toggleVisibility(archivoId) {
    fetch(`/archivos/${archivoId}/toggle-visibility`, {
        method: 'POST',
        headers: {

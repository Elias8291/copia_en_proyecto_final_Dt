                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Gestiona los tipos de archivos requeridos en los trámites.
                                </p>
                            </div>
                        </div>
                ...
                <div class="p-6 bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-200/70">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-3 mb-4">
                        ...
                        <div class="relative">
                            ...
                            <select id="tipo-persona-filter"
                                class="appearance-none bg-white border border-gray-300 rounded-lg pl-10 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/30 focus:border-[#B4325E] transition-all duration-200 hover:shadow-sm min-w-[140px]">
                        ...
                        <div class="relative">
                            ...
                            <select id="tipo-archivo-filter"
                                class="appearance-none bg-white border border-gray-300 rounded-lg pl-10 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/30 focus:border-[#B4325E] transition-all duration-200 hover:shadow-sm min-w-[120px]">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.toggleVisibility = function(archivoId) {
            console.log('Toggling visibility for archivo:', archivoId);
        };

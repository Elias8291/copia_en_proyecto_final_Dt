        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200/70">
            ...
            <div class="p-6 bg-gray-50/50 border-b border-gray-200/70">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                    ...
                    <!-- Tipo de Persona -->
                    <div>
                        <label for="tipo-persona-filter" class="block text-sm font-medium text-gray-700 mb-1">Tipo de Persona</label>
                        <select id="tipo-persona-filter" class="block w-full pl-4 pr-10 py-2.5 border border-gray-300 bg-white rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/50 focus:border-[#B4325E] transition-all duration-300 hover:shadow-md">
                    ...
                    <!-- Tipo de Archivo -->
                    <div>
                        <label for="tipo-archivo-filter" class="block text-sm font-medium text-gray-700 mb-1">Tipo de Archivo</label>
                        <select id="tipo-archivo-filter" class="block w-full pl-4 pr-10 py-2.5 border border-gray-300 bg-white rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/50 focus:border-[#B4325E] transition-all duration-300 hover:shadow-md">
                            <option value="">Todos</option>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 items-end mt-4">
                    ...
                    <div>
                        ...
                        <select id="estado-filter" class="block w-full pl-4 pr-10 py-2.5 border border-gray-300 bg-white rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/50 focus:border-[#B4325E] transition-all duration-300 hover:shadow-md">
                            <option value="">Todos</option>
...
@foreach($archivos as $archivo)
    <x-modal name="confirm-archivo-deletion-{{ $archivo->id }}" focusable maxWidth="md">
        <div class="p-6">
            <div class="flex items-center justify-center space-x-4 mb-6">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500">¿Estás seguro de que deseas eliminar el archivo "{{ $archivo->nombre }}"? Esta acción no se puede deshacer.</p>
                </div>
            </div>
            <div class="mt-6 flex justify-center space-x-3">
                ...
                <form action="{{ route('archivos.destroy', $archivo) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
...
@push('scripts')
<script src="{{ asset('js/archivos-dynamic-filter.js') }}"></script>
@endpush

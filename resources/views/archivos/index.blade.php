                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Gestiona los tipos de archivos requeridos en los trámites.</p>
                        </div>
                    </div>
            ...
            <div class="p-6 bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-200/70">
                ...
                <div class="mb-6">
                    <div class="relative max-w-2xl mx-auto group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <div class="relative">
                                <svg class="h-5 w-5 text-gray-400 group-focus-within:text-[#B4325E] transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                                </svg>
                                <div class="absolute -inset-1 bg-gradient-to-r from-[#B4325E]/20 to-[#7a1d37]/20 rounded-full opacity-0 group-focus-within:opacity-100 transition-opacity duration-200 blur-sm"></div>
                            </div>
                        </div>
                        ...
                        <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-[#B4325E]/5 to-[#7a1d37]/5 opacity-0 group-focus-within:opacity-100 transition-opacity duration-200 pointer-events-none"></div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap items-center justify-center gap-3 mb-4">
                    ...
                    <div class="relative">
                        ...
                        <select id="tipo-persona-filter" class="appearance-none bg-white border border-gray-300 rounded-lg pl-10 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/30 focus:border-[#B4325E] transition-all duration-200 hover:shadow-sm min-w-[140px]">
                    ...
                    <div class="relative">
                        ...
                        <select id="tipo-archivo-filter" class="appearance-none bg-white border border-gray-300 rounded-lg pl-10 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/30 focus:border-[#B4325E] transition-all duration-200 hover:shadow-sm min-w-[120px]">
                    ...
                    <div class="relative">
                        ...
                        <select id="estado-filter" class="appearance-none bg-white border border-gray-300 rounded-lg pl-10 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#B4325E]/30 focus:border-[#B4325E] transition-all duration-200 hover:shadow-sm min-w-[100px]">
                ...
                <div class="text-center">
                    <div id="results-count" class="text-sm text-gray-600 font-medium bg-white/60 backdrop-blur-sm rounded-full px-4 py-1 inline-block border border-gray-200/50"></div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    new TablaFiltros({
        ...
        messages: {
            ...
            results: 'archivo',
            results_plural: 'archivos'
        },
        filtros: [
            { id: 'search-filter', columna: 1, tipo: 'contains', label: 'texto' },
            { id: 'tipo-persona-filter', columna: 2, selector: 'span', tipo: 'tipo_persona', label: 'tipo de persona' },
            { id: 'tipo-archivo-filter', columna: 3, selector: 'span', tipo: 'contains', label: 'tipo de archivo' },
            { id: 'estado-filter', columna: 4, selector: 'button', tipo: 'estado', label: 'estado' }
        ]
    });
});
</script> 
...
<div class="min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Nuevo Archivo</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200/70">
            ...
            <div class="p-6 border-b border-gray-200/70">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Agrega un nuevo tipo de archivo al catálogo del sistema.</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Formulario -->
            <div class="p-6">
                <form action="{{ route('archivos.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="bg-gray-50/50 rounded-xl p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="tipo_archivo" 
                                    ...
                                    <option value="pdf" {{ old('tipo_archivo') === 'pdf' ? 'selected' : '' }}>PDF - Documento</option>
                                    <option value="png" {{ old('tipo_archivo') === 'png' ? 'selected' : '' }}>PNG - Imagen</option>
                                    <option value="mp3" {{ old('tipo_archivo') === 'mp3' ? 'selected' : '' }}>MP3 - Audio</option>
                                </select>
                                @error('tipo_archivo')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div>
                            ...
                            <textarea id="descripcion" 
                                      ...
                                      placeholder="Describe brevemente qué tipo de documento es y para qué se utiliza...">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="tipo_persona" 
                                    ...
                                    <option value="Física" {{ old('tipo_persona') === 'Física' ? 'selected' : '' }}>Solo Persona Física</option>
                                    <option value="Moral" {{ old('tipo_persona') === 'Moral' ? 'selected' : '' }}>Solo Persona Moral</option>

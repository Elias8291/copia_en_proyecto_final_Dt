                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="text-lg font-mono text-gray-800">{{ $proveedor->rfc ?? 'N/A' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                ...
                                @if($proveedor->estado_padron === 'vigente')
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="text-gray-800 font-medium">{{ $proveedor->fecha_alta_padron ? $proveedor->fecha_alta_padron->format('d/m/Y') : 'N/A' }}</div>
                        </div>

                        <div class="bg-gray-50 rounded-lg p-4">
                            <div class="text-gray-500 text-xs uppercase font-semibold tracking-wide mb-2">Fecha de Vencimiento</div>
                            <div class="text-gray-800 font-medium">{{ $proveedor->fecha_vencimiento_padron ? $proveedor->fecha_vencimiento_padron->format('d/m/Y') : 'N/A' }}</div>
                        </div>
                    </div>
                </div>
            @else

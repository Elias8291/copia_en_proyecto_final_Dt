        ...
        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <nav class="px-3 space-y-2">
                ...
                <a href="{{ route('logs.index') }}" @click="sidebarOpen = false" class="group flex items-center px-3 py-3 text-base font-medium rounded-xl transition-all duration-200 
                    ...
                    <svg class="{{ request()->routeIs('logs.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary' }} flex-shrink-0 w-6 h-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="font-medium tracking-wide">Logs</span>
                </a>
                @endcan

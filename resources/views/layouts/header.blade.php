            ...
            <div class="hidden md:flex items-center space-x-4 pr-4">
                ...
                <div class="relative" x-data="{ notificationsOpen: false }">
                    <button @click="notificationsOpen = !notificationsOpen" 
                        ...
                        <svg class="w-6 h-6 text-gray-500 group-hover:text-primary transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div x-show="notificationsOpen" 
                        ...
                        <div class="px-4 py-3 bg-gradient-to-r from-primary to-primary-dark flex items-center justify-between">
                            ...
                            <span class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-primary bg-white rounded-full">
                                3 nuevas
                            </span>
                        </div>
                            ...
                            <div class="p-4 bg-primary-50/30 hover:bg-primary-50/50 transition-colors duration-200">
                                <div class="flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Se ha asignado el trámite #12345 para su revisión.</p>
                                        <div class="mt-2 flex items-center justify-between">
                                            <span class="text-xs text-gray-500">Hace 5 minutos</span>
                                            <button class="text-xs text-primary hover:text-primary-dark font-medium">Marcar como leído</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            
                            <!-- Notificación no leída - Documento -->
                            <div class="p-4 bg-primary-50/30 hover:bg-primary-50/50 transition-colors duration-200">
                                <div class="flex">
                                    <div class="flex-shrink-0 mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">El proveedor ha actualizado su documentación.</p>
                                        <div class="mt-2 flex items-center justify-between">
                            ...
                            <div class="p-4 bg-primary-50/30 hover:bg-primary-50/50 transition-colors duration-200">
                                <div class="flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Tiene 3 trámites pendientes por revisar.</p>
                                        <div class="mt-2 flex items-center justify-between">
                            ...
                            <div class="p-4 hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 mt-1">El sistema estará en mantenimiento el próximo domingo.</p>
                                        <div class="mt-2 flex items-center justify-between">
                        ...
                        <div class="p-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                            <a href="{{ route('notificaciones.index') }}" class="text-xs text-primary hover:text-primary-dark font-medium">
                        ...
                        <div class="px-4 py-4 bg-gradient-to-r from-primary/10 to-primary-dark/10">
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm font-semibold text-gray-900 truncate">
                                        {{ auth()->check() ? auth()->user()->correo : 'Invitado' }}
                                    </p>

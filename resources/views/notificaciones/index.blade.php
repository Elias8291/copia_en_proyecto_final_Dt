                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center gap-2 ml-4">
                                ...
                                <form id="form-eliminar-{{ $notificacion->id }}" method="POST" action="{{ route('notificaciones.eliminar', $notificacion) }}" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" 
                                            onclick="confirmarEliminacion('{{ $notificacion->id }}', '{{ $notificacion->titulo }}')"

            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-base text-gray-500 mt-1">Información completa del usuario</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 border border-gray-200/60">
                        <div class="flex items-center mb-2">
                            ...
                            <span class="text-base font-semibold text-gray-600 uppercase tracking-wide">Nombre Completo</span>
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 border border-gray-200/60">
                        <div class="flex items-center mb-2">
                            ...
                            <span class="text-base font-semibold text-gray-600 uppercase tracking-wide">Correo Electrónico</span>
                        </div>
                ...
                <div class="mt-3">
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 border border-gray-200/60 max-w-xs">
                        <div class="flex items-center mb-2">
                            ...
                            <span class="text-base font-semibold text-gray-600 uppercase tracking-wide">RFC</span>
                        </div>
                        <p class="text-lg font-semibold text-gray-900">{{ $user->rfc }}</p>
                    </div>
                </div>
                @endif
            </div>
                    ...
                    @empty
                        <div class="col-span-full">
                            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 border border-gray-200/60 text-center">
                                ...
                                <p class="text-base text-gray-600 font-medium">No tiene roles asignados</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-2.5 border border-gray-200/60">
                        <div class="flex items-center mb-1.5">
                            ...
                            <span class="text-base font-semibold text-gray-600 uppercase tracking-wide">Último Acceso</span>
                        </div>
                ...
                <div class="mt-3">
                    <div class="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-3 border border-red-200/60">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-base font-semibold text-red-800">Usuario Eliminado</p>

...
@section('content')
<div class="w-full max-w-3xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-200/50 p-4">
    <!-- Header mejorado -->
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Modifique la información requerida</p>
                    </div>
                </div>
        ...
        <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-4 p-4">
            ...
            <div class="pb-4">
                ...
                <div class="space-y-3">
                    ...
                    <p class="text-sm text-gray-400 flex items-center">
                        ...
                        Si no se selecciona ningún rol, se mantendrán los roles actuales
                    </p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 border border-gray-200/60">
                <div class="flex items-center mb-2">
                    ...
                    <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">Información del Usuario</h4>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                    <div class="bg-white/60 rounded-md p-2">
                        <span class="text-gray-500 font-medium">ID:</span>
                        <span class="ml-1 font-semibold text-gray-900">#{{ $user->id }}</span>
                    </div>
                    <div class="bg-white/60 rounded-md p-2">
                        <span class="text-gray-500 font-medium">Estado:</span>
                        <span class="ml-1 font-semibold {{ $user->deleted_at ? 'text-red-600' : 'text-green-600' }}">
